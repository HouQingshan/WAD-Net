...
IDRiD_path = "/home/houqs/EyeCls/datatrain_patch_withlabel_arg_fake/"
...
train_images_filepaths = IDRiD_path_images_filepaths[:40000]
val_images_filepaths = IDRiD_path_images_filepaths[40000:]
...
log_dir = "./PTH_Instance/resnet50_for_Instance_Decision.pth"
...
for epoch in range(start_epoch + 1, start_epoch + 1 + params["epochs"]):
	...
	if best_metric < accuracy_val:
		...
		logdir = "./PTH_Instance/resnet50_for_Instance_Decision.pth"
