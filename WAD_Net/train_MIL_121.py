...
from WAD_Net.networks.MIL121_model import Create_MIL_model
...
model_pre = getattr(models, params["model_cls"])(pretrained=True)
...
log_MIL_dir = "./PTH_MIL/MIL121_train.pth"
...
for epoch in range(start_epoch + 1, start_epoch + 1 + params["epochs"]):
	...
	if best_metric < accuracy_val2:
		...
		logdir = "./PTH_MIL/MIL121_train.pth"
